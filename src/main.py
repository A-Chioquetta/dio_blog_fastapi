...
tags_metadata = [
    ...
    },
    {
        ...
        "externalDocs": {"description": "Documentação externa para Posts.api", "url": "https://post-api.com/"},
    },
]

servers = [
    {"url": "http://localhost:8000/", "description": "Ambiente de desenvolvimento"},
    {"url": "https://dio-blog-fastapi-n10u.onrender.com", "description": "Ambiente de produção"},
]
